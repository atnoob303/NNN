...
function _liquidEnsureFilter(elId, noise, distort) {
  ...
  // Nếu filter đã tồn tại → chỉ cập nhật scale distort
  ...
  // feImage — noise PNG thật (tự nhiên hơn feTurbulence)
  // Bạn thay chuỗi base64 bên dưới bằng noise PNG của bạn
  ...
  // feDisplacementMap — bẻ cong ảnh nền bằng noise PNG
